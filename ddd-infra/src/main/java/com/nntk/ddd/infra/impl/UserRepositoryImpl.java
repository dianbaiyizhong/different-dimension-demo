...
public class UserRepositoryImpl implements IUserRepository {
    ...
    public UserBO queryById(int id) {
        ...
        return UserConvertor.INSTANCE.do2Bo(tUserDO);
    }
    ...
    public void save(UserBO user) {
        TUserDO po = UserConvertor.INSTANCE.bo2Do(user);
    ...
    public PageResult<UserBO> getUserList(CommonQueryDto commonQueryDto) {
        ...
        List<UserBO> userBos = UserConvertor.INSTANCE.do2Bo(pager.getRecords());
